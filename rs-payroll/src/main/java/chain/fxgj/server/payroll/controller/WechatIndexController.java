...
public class WechatIndexController {
    ...
    public Mono<Res100705> wxCallback(@RequestHeader(value = "encry-salt", required = false) String salt,
        ...
        return Mono.fromCallable(() -> {
            ...
            Optional.ofNullable(insideFeignController.getSkin(cacheUserPrincipal.getIdNumberEncrytor(),jsessionId)).ifPresent(tuple->res100705.setThemeId(tuple.getThemeId()));
